...
import com.eroglu.architecture.TodoDestinationsArgs.TASK_ID_ARG
import com.eroglu.architecture.TodoDestinationsArgs.TITLE_ARG
import com.eroglu.architecture.TodoDestinationsArgs.USER_MESSAGE_ARG
import com.eroglu.architecture.TodoScreens.ADD_EDIT_TASK_SCREEN
import com.eroglu.architecture.TodoScreens.STATISTICS_SCREEN
import com.eroglu.architecture.TodoScreens.TASKS_SCREEN
import com.eroglu.architecture.TodoScreens.TASK_DETAIL_SCREEN

//  Screens used in [TodoDestinations]
// Ekranlar için rotalar (adresler)
...
// Ekranlar arası gönderilen argümanların (parametrelerin) anahtarları
...
// Tam navigasyon hedefleri (argümanlarla birlikte)
...
// Navigasyon eylemlerini yöneten yardımcı sınıf
